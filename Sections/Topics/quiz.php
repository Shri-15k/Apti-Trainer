    ...
    <script type="module">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function updateTimer() {
                ...
                if (totalTime <= 0) {
                    // End the exam when the timer reaches zero
                    clearInterval(timerInterval);
                    alert('Time is up! Exam ended.');
                    // Add any additional logic to handle exam end
                }
            ...
            function submitTest() {
                ...
                nextQuestion(); // Call nextQuestion() to show the result after submission
                                ...
                                // Assume allQuestions is your JavaScript array of objects
                ...
                // .catch(error => console.error('Error:', error));
                    // Serialize data
                const allQuestionsJSON = JSON.stringify(allQuestions);

                // Save to localStorage
                localStorage.setItem('allQuestions', allQuestionsJSON);
...
<body>
    ...
    <div style="display: flex; padding-top: 10px; ">
        ...
        <button id="startBtn" style="margin-left: 10px; padding-left: 20px;padding-top: 10px;padding-right: 20px;padding-bottom: 10px; width: 80px; background-color: blue; border: none; color: white;
        border-radius: 8px;">Start</button>
        <button id="exitBtn" style="margin-left: 20px; padding-left: 20px;padding-top: 10px;padding-right: 20px;padding-bottom: 10px; width: 80px; background-color: blue; border: none; color: white;
    ...
    <!-- <hr width="98%"> -->
    <div id="timer"
        style="height: 40px; border: 1px solid; background-color: rgb(11, 10, 10); color: white; padding: 10px; font-size: larger; margin: 0px 150px 0px 30px;">
    </div>
    <br>
    <br>
            ...
            <div style="width: 50%;">
                <div style="width: 100%; margin-left: 10px; display: flex; justify-content: left; flex-direction: column;">
                    ...
                    <div>
                        ...
                        <!-- <button id="clearBtn" class="btn" style="margin-left: 20px;border: 0px; text-decoration: underline;">Clear answer</button> -->
                    </div>
